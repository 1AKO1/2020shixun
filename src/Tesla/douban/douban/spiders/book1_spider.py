    ...
    def parse_book(self, response):
        ...
        if response.status == 200:
            try:
                ...
                elif response.xpath('//div[@id="collector"]/p[3]') is None and response.xpath('//div[@id="collector"]/p[2]'):
                ...
                elif response.xpath('//div[@id="collector"]/p[2]') is None and response.xpath('//div[@id="collector"]/p[1]'):
                    item['book_readings'] = 0
                    item['book_reads'] = 0
                    item['book_toReads'] = int(convert_field(response.xpath(
                        '//div[@id="collector"]/p[1]/a/text()').get()).split('人想读')[0])
